...
* **Non-jailed shell-user:** A creation of at least one Non-jailed shell-user (per website) is required for the particular feature of "Detached Git Tracking" to work.

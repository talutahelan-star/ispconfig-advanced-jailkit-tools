...
* **Detached Git Tracking:** Clone and track your website (`web/`) securely using a detached Git worktree managed from the Vault.
  * **Prerequisite:** This feature relies on the secure Vault which is outside the Jail. Because of this, for any website where you want to use it, there must be at least one Non-Jailed shell-user created.
